...
<section
    ...
    <div class="__wrapper c-main">
        ...
        <div class="table-expand-wrapper relative pb-6">
            ...
            <div class="table-scroll-container overflow-hidden bg-white shadow-sm relative max-h-[360px] transition-all duration-500">
                <div class="grid  md:grid-cols-5 text-center bg-lighter border-b border-secondary-100">
                    <div class="py-3"></div>
                ...
                <div>
                    ...
                    <div @class([
                        'grid grid-cols-5 border-b border-gray-100',
                        'bg-bg' => $loop->odd 
                    ])>
...
<path d="M6.77138 9.12868L6.77138 4.76837e-06L5.22861 -9.53674e-07L5.22861 9.12868L1.09091 5.10571L0 6.16638L5.99999 12L12 6.16636L10.9091 5.1057L6.77138 9.12868Z" fill="white"/>
</svg>
                </button>
            </div>
