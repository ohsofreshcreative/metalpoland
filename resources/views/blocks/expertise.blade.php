...
<section
	...
	@class([
		'b-expertise relative bg-white -spt -spb',
	...
	<div class="__wrapper c-main relative">
		...
		<div class="sticky top-20 z-30 bg-darken p-4 mb-10">
			<div class="swiper expertise-nav-slider overflow-hidden w-full">
					...
					@foreach($r_expertise as $item)
						<div class="swiper-slide ">
							<a
								...
								class="block min-w-[180px] text-white bg-brand min-h-[52px] flex items-center justify-center text-center px-4 transition hover:opacity-80">
								{{ $item['title'] }}
							</a>
						</div>
					@endforeach
