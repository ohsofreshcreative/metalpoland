	...
	<div class="__wrapper c-main relative">
		<div class="__col grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-20">
			...
			<div data-gsap-element="img" class="__img h-full order1">
				<img class="absolute z-10 bottom-10 right-48" src="/wp-content/uploads/2026/06/small-diamond.svg" />
				<img class="absolute z-10 top-1/2 -translate-y-1/2 -left-20" src="/wp-content/uploads/2026/06/shape.svg" />
				<img class="mask-img aspect-square" src="{{ $g_additional['image']['url'] }}" alt="{{ $g_additional['image']['alt'] ?? '' }}">
			</div>
			@endif
